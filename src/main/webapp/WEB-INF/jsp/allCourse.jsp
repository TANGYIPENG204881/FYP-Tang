...
<div class="container">
  <div class="row clearfix">
    <div class="col-md-12 column">
      ...
      <div class="page-header">
        <h1>
          <small>Course list -- all courses</small>
        </h1>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-4 column">
      <!-- toAddClient -->
      <a class="btn btn-primary" href="${pageContext.request.contextPath}/course/toAddCourse">Add Course</a>
      <a class="btn btn-primary" href="${pageContext.request.contextPath}/course/allCourse">Show all</a>
    </div>
    ...
    <div class="col-md-4 column">
      ...
      <form action="${pageContext.request.contextPath}/course/queryCourse" method="post" style="float: right" class="form-inline">
        ...
        <input type="text" name="queryCourseName" class="form-control" placeholder="Enter query by name">
      ...
      <table class="table table-hover table-striped">
        ...
        <c:forEach var="course" items="${list}">
          <tr>
            ...
            <td>
              <a href="${pageContext.request.contextPath}/course/toUpdateCourse?id=${course.courseID}" style='color: #23beb5'>Update</a>
              &nbsp; | &nbsp;
              <a href="${pageContext.request.contextPath}/course/toDeleteCourse/${course.courseID}" style='color: #ee1f2f'>Delete</a>
            </td>
          </tr>
        </c:forEach>
        </tbody>
